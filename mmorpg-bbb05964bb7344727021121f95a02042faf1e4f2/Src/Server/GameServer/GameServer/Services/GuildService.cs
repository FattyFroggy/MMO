...
namespace GameServer.Services
{
    class GuildService:Singleton<GuildService>
    {
        public GuildService()
        {
            MessageDistributer<NetConnection<NetSession>>.Instance.Subscribe<SkillBridge.Message.GuildCreateRequest>(this.OnGuildCreate);
            MessageDistributer<NetConnection<NetSession>>.Instance.Subscribe<SkillBridge.Message.GuildListRequets>(this.OnGuildList);
            MessageDistributer<NetConnection<NetSession>>.Instance.Subscribe<SkillBridge.Message.GuildJoinRequest>(this.OnGuildJoinRequest);
            MessageDistributer<NetConnection<NetSession>>.Instance.Subscribe<SkillBridge.Message.GuildJoinResponse>(this.OnGuildJoinResponse);
            MessageDistributer<NetConnection<NetSession>>.Instance.Subscribe<SkillBridge.Message.GuildLeaveRequest>(this.OnGuildLeave);
            MessageDistributer<NetConnection<NetSession>>.Instance.Subscribe<SkillBridge.Message.GuildAdminRequest>(this.OnGuildAdmin);
        }
        ...
        public void OnGuildCreate(NetConnection<NetSession> sender,GuildCreateRequest request)
        {
            ...
            if (character.Guild != null)
            {
                ...
                sender.Session.Response.guildCreate.Errormsg = "创建失败已有工会";
                sender.SendResponse();
                return;
            }
        ...
        private void OnGuildList(NetConnection<NetSession> sender, GuildListRequets message)
        {
            Character character = sender.Session.Character;
        ...
        private void OnGuildAdmin(NetConnection<NetSession> sender, GuildAdminRequest message)
        {
            ...
            if (character.Guild == null)
            {
                ...
                sender.Session.Response.guildAdmin.Erromsg = "你没工会";
                sender.SendResponse();
                return;
            }
