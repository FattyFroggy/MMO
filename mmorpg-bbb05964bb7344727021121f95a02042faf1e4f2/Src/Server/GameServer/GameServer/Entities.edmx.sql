...
IF OBJECT_ID(N'[dbo].[FK_TCharacterTCharacterFriend]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TCharacterFriends1] DROP CONSTRAINT [FK_TCharacterTCharacterFriend];
GO
...
-- Creating table 'TCharacterFriends1'
CREATE TABLE [dbo].[TCharacterFriends1] (
    [Id] int IDENTITY(1,1) NOT NULL,
...
-- Creating primary key on [Id] in table 'TCharacterFriends1'
ALTER TABLE [dbo].[TCharacterFriends1]
ADD CONSTRAINT [PK_TCharacterFriends1]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating foreign key on [CharacterID] in table 'TCharacterFriends1'
ALTER TABLE [dbo].[TCharacterFriends1]
