...
namespace Assets.Scripts.Managers
{
    ...
    class QuestManager:Singleton<QuestManager>
    {
        ...
        private void AddNpcQuest(int npcId, Quest quest)
        {
            ...
            List<Quest> availavles;
            List<Quest> complates;
            List<Quest> incomplates;

            if(!this.npcQuests[npcId].TryGetValue(NpcQuestStatus.Available,out availavles))
            {
                availavles = new List<Quest>();
                this.npcQuests[npcId][NpcQuestStatus.Available] = availavles;
            }
        ...
        {
            Debug.LogFormat("ShowQuestDialog:[{0}]",quest.Define.ID);
        ...
        {
            Debug.LogFormat("OnQuestDialogClose:[{0}]",result);
