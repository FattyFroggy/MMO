...
public class DataManager : Singleton<DataManager>
{
    ...
    public void Load()
    {
        Debug.Log(this.DataPath + "MapDefine.txt");
        ...
        Debug.Log(this.DataPath + "ItemDefine.txt");
        ...
        Debug.Log(this.DataPath + "Equips.txt");
        ...
        Debug.Log(this.DataPath + "QuestDefine.txt");
        ...
        Debug.Log(this.DataPath + "RideDefine.txt");
    }
