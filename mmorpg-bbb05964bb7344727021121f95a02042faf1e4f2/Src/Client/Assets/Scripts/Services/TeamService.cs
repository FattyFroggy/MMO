...
namespace Assets.Scripts.Services
{
    public class TeamService : Singleton<TeamService>, IDisposable
    {
        public TeamService()
        {
            MessageDistributer.Instance.Subscribe<SkillBridge.Message.TeamInviteRequest>(this.OnTeamInviteRequest);
            MessageDistributer.Instance.Subscribe<SkillBridge.Message.TeamInviteResponse>(this.OnTeamInviteResponse);
            MessageDistributer.Instance.Subscribe<SkillBridge.Message.TeamInfoResponse>(this.OnTeamInfo);
            MessageDistributer.Instance.Subscribe<SkillBridge.Message.TeamLeaveResponse>(this.OnTeamLeave);
        }
        public void Init()
        {
        ...
        public void Dispose()
        {
            MessageDistributer.Instance.Unsubscribe<SkillBridge.Message.TeamInviteRequest>(this.OnTeamInviteRequest);
            MessageDistributer.Instance.Unsubscribe<SkillBridge.Message.TeamInviteResponse>(this.OnTeamInviteResponse);
            MessageDistributer.Instance.Unsubscribe<SkillBridge.Message.TeamInfoResponse>(this.OnTeamInfo);
            MessageDistributer.Instance.Unsubscribe<SkillBridge.Message.TeamLeaveResponse>(this.OnTeamLeave);
        }
        private void OnTeamInviteRequest(object sender, TeamInviteRequest request)
        {
            Debug.LogFormat("OnTeamInviteRequest:From{0}", request.FromName);
        ...
        public void SendTeamInviteResponse(bool accept, TeamInviteRequest request)
        {
            ...
            message.Request.teamInviteRes.Errormsg = accept ? "组队成功" : "组队失败";
