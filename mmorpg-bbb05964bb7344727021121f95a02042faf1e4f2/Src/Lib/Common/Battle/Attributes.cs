...
using static Common.Battle.Define;
...
namespace Common.Battle
{
    class Attributes
    {
        ...
        public float MP
        {
            ...
            set { dynamic.Hp = (int)Math.Min(MaxMP, value); }
        }
        ...
        private void InitSecondaryAttributes()
        {
            ...
            this.Basic.DEF = this.Basic.STR * 2 + this.Initial.DEF + this.Equip.DEF;
            this.Basic.MDEF = this.Basic.INT * 2 + this.Initial.MDEF + this.Equip.MDEF;

            this.Basic.SPD = this.Basic.STR * 10 + this.Initial.SPD + this.Equip.SPD;
            this.Basic.CRI = this.Basic.CRI * 10 + this.Initial.CRI + this.Equip.CRI;
        }
